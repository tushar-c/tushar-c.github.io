...
$$\frac{\partial a_j}{\partial w_{ij}} = \frac{\partial \sum_{i} (w_{ij} * x_{i}) + b_j} = x_i$$

The other quantity is given by:

$$\frac{\partial a_j}{\partial b_{j}} = \frac{\partial \sum_{i} (w_{ij} * x_{i}) + b_j)}{\partial b_{bj}} = \frac{\partial b_j)}{\partial b_{bj}} = 1$$
