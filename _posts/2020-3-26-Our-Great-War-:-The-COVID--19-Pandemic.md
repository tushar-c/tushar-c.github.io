...
However, once they breach into a host cell, that is when they exhibit all the habits you would expect from living beings. They can create more copies of themselves (this is really all there is to the world, basically :) ) and package them for redistribution, as well as derive energy from the host to keep replicating. 
